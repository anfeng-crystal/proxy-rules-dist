...
function main(config, profileName) {
  ...
  const REGION_CONFIGS = [
    ["🇭🇰 香港", "(?i)(香港|港澳|港区|hong ?kong|hongkong|hkg|hk|🇭🇰|港服|港线)"],
    ["🇯🇵 日本", "(?i)(日本|japan|jp|tokyo|東京|osaka|大阪|tyo|nrt|hnd|🇯🇵)"],
    [
      "🇺🇸 美国",
      "(?i)(美国|美國|united ?states|seattle|san ?jose|los ?angeles|new ?york|🇺🇸|(^|[^a-z])(usa|us|lax|sfo|sea|nyc|jfk|ord|dfw|atl|sjc)($|[^a-z]))",
    ],
    ["🇸🇬 新加坡", "(?i)(新加坡|singapore|sg|sin|sgp|狮城|獅城|星洲|🇸🇬)"],
    ["🇹🇼 台湾", "(?i)(台湾|臺灣|台灣|taiwan|tw|tpe|taipei|台北|🇹🇼|formosa)"],
  ];
