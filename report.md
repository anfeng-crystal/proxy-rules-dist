...
- AI: 150 domain rules, 6 classical-only rules omitted, 1506 bytes
- Ads: 256980 domain rules, 765 classical-only rules omitted, 2236822 bytes
...
- Domestic: 113406 domain rules, 155 classical-only rules omitted, 552935 bytes
...
- SpeedTest: 3272 domain rules, 2 classical-only rules omitted, 35833 bytes
